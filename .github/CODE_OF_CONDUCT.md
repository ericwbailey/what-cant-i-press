...
I ([Eric Bailey](https://ericwbailey.website/)) believe that people who want to contribute to this project should be able to. This means creating a safe, inclusive environment.

## Criteria

If you choose to participate in this project, you agree to not discriminate based on the following criteria:
...
Anyone asked to stop unacceptable behavior is expected to comply immediately. This includes temporarily or permanently ceasing current and future contributions to this project, regardless of the size or scale of their impact.
...
* The app
* Supporting resources and services (ex: [GitHub](https://github.com/ericwbailey/what-cant-i-press))
